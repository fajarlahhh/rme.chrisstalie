                                ...
                                <div class="row vital-signs-grid">
                                    <div class="col-md-3 mb-3">
                                        ...
                                        <input type="text" class="form-control" id="tekanan_darah"
                                            name="tekanan_darah" placeholder="120/80" wire:model="tekanan_darah">
                                        @error('tekanan_darah')
                                            <span class="text-danger">{{ $message }}</span>
                                        @enderror
                                    </div>
                                    ...
                                    <div class="col-md-3 mb-3">
                                        ...
                                        <input type="number" class="form-control" id="saturasi_o2"
                                            name="saturasi_o2" placeholder="98" wire:model="saturasi_o2">
                                        @error('saturasi_o2')
                                            <span class="text-danger">{{ $message }}</span>
                                        @enderror
                                    </div>
                                    <div class="col-md-3 mb-3">
                                        ...
                                        <input type="number" class="form-control" id="berat_badan"
                                            name="berat_badan" step="0.1" placeholder="65.5"
                                        ...
                                        <div class="pemeriksaan-item">
                                            ...
                                            <div class="form-check mb-2">
                                                <input class="form-check-input" type="checkbox"
                                                    id="ekstremitas_normal" wire:model.live="ekstremitas_normal">
                        ...
                        <div class="note alert-primary mb-2">
                            ...
                            <div class="note-content">
                                ...
                                <div class="mb-3">
                                    <label class="form-label">Usia</label>
                                    <input class="form-control" type="text"
                                        value="{{ $data->pasien->umur }} Tahun" disabled />
                                </div>
                                <div class="mb-3">
                                    <label class="form-label">Jenis Kelamin</label>
                                    <input class="form-control" type="text"
                            ...
                            <div class="note-content">
                                ...
                                <div class="mb-3">
                                    ...
                                    <div class="input-group"> <input type="number" id="waktu_tes_detik"
                                            name="waktu_tes_detik" placeholder="Contoh: 11.5"
                                            wire:model="waktu_tes_detik" step="0.01" class="form-control"
                                            required>
                                ...
                                <div class="mb-3">
                                    ...
                                    <div class="form-check">
                                        <input class="form-check-input" type="radio" name="risiko_jatuh"
                                            value="Rendah" wire:model="risiko_jatuh" id="risiko_jatuh_rendah">
