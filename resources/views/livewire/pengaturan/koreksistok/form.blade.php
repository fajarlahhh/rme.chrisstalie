<div>
    ...
    <h1 class="page-header">Koreksi Stok <small>Form</small></h1>
    ...
    <div class="panel panel-inverse" data-sortable-id="form-stuff-1">
        ...
        <div class="panel-body">
            ...
            <div class="mb-3">
                <label class="form-label">Qty Dikeluarkan</label>
                <input type="number" class="form-control" wire:model="qty_keluar" autocomplete="off">
                @error('qty_keluar')
        ...
        <div class="panel-footer">
            ...
            @endrole
            <button type="button" onclick="window.location.href='/pengaturan/koreksistok/index'"
