<div>
    ...
    <li class="breadcrumb-item">Statistik</li>
        <li class="breadcrumb-item active">Penggunaan Alat</li>
    @endsection

    <!-- BEGIN page-header -->
    <h1 class="page-header">Penggunaan Alat</h1>
    <!-- END page-header -->
    ...
    <div class="panel panel-inverse" data-sortable-id="table-basic-2">
        ...
        <div class="panel-body table-responsive">
            <x-alert />
            @include('livewire.laporan.statistik.penggunaanalat.cetak', ['cetak' => false])
        </div>
    </div>
    <x-modal.cetak judul="Penggunaan Alat" />
