...
class Form extends Component
{
    ...
    public function submit()
    {
        ...
        DB::transaction(function () {
            ...
            $pengadaanPemesanan->jenis = 'Alat dan Bahan';
            ...
            JurnalkeuanganClass::insert(
                ...
                tanggal: now(),
                uraian: 'Stok Masuk Alat dan Bahan ' . $pengadaanPemesanan->uraian,
                system: 1,
        ...
        $this->redirect('/manajemenstok/pengadaanbrgdagang/lainnya/alatdanbahan');
    }

    public function render()
    {
        return view('livewire.manajemenstok.pengadaanbrgdagang.lainnya.alatdanbahan.form');
    }
}
